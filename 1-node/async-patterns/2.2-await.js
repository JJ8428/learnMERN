...
const start = async() => {
    ...
    const first = await writeFilePromise('./content_random_1.txt', 'utf8')
    const second = await readFilePromise('./content_random_2.txt', 'utf8')
    await writeFilePromise('./content/result_mind-grenade.txt', 'This is confusing!!!')
